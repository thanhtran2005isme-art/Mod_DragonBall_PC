...
public class GClass14 : GInterface0
{
	...
	protected static GClass14 gclass14_0 = new GClass14();
	...
	private static GClass15 gclass15_0 = new GClass15();
	...
	public void method_0()
	{
		gclass15_0.list_0.Clear();
	}

	public static GClass14 smethod_0()
	{
		if (gclass14_0 == null)
	...
	public void method_2(string host, int port)
	{
		if (GClass172.smethod_0().bool_1 && GClass151.bool_1)
		{
			...
			thread_2 = new Thread(gclass15_0.method_1);
			thread_2.Start();
