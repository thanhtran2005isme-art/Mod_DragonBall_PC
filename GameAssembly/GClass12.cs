	...
	public void onMessage(GClass208 msg)
	{
		...
		try
		{
			...
			case 32:
			{
				...
				for (int num17 = 0; num17 < GClass144.gclass88_10.method_2(); num17++)
				{
					...
					if (gClass10.gclass127_0.int_0 == num16 && gClass10.Equals(GClass78.smethod_1().gclass79_0))
					{
						...
						if (KOLTracker.ObserveNpcDialog(num16, chat, array4))
							return;
				...
				bool suppressKolDialog = KOLTracker.ObserveNpcDialog(num16, chat2, array5);
				try
				{
			...
			case 38:
			{
				...
				if (KOLTracker.ObserveNpcSay(num165, chat3))
					break;
				...
				else
				{
					...
					case -12:
					{
						...
						if (gClass66 == null || gClass66.int_12 == 0 || gClass66.int_12 == 0)
							break;
						bool kolMatchedOwnCombatProbe = GClass7.OnMobCombatTerminalResponse(gClass66.int_25);
						...
						try
						{
							...
							for (int num188 = 0; num188 < b63; num188++)
							{
								...
								if (gClass67.int_8 == GClass78.smethod_1().int_13)
									kolHasOwnDrop = true;
								else if (gClass67.int_8 > 0)
									kolHasForeignOwnedDrop = true;
						...
						KOLTracker.ObserveMobDeath(kolMatchedOwnCombatProbe, kolHasOwnDrop, kolHasForeignOwnedDrop);
						break;
					}
					case -11:
					{
